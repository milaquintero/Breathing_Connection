...
class FancyTextFormField extends StatefulWidget {
  ...
  FancyTextFormField({this.fieldType, this.fieldLabel, this.keyboardType, this.onSaved, this.shouldResetIfNull = false, this.isGrouped = false});
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        validator: (value) {
          ...
          else if(widget.fieldType == 'text' && !RegExp(r'^[a-zA-Z]+$').hasMatch(value)){
